...
function prompt_grml_precmd () {
    ...
    left_items=(virtual-env rc change-root user at host path vcs percent)
...
alias grep='grep --color -inI'
alias rgrep='grep -r'


xsource .bash_aliases
...
export HTTP_PROXY=proxy.onysos.fr:3128
